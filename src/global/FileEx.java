...
public class FileEx {
	public static void main(String[] args) {
		...
		try {
			while (true) {
				switch (JOptionPane.showInputDialog("1생성 2쓰기 3읽기 4 수정 5삭제 0종료")) {
				case "1":
					String fileName = JOptionPane.showInputDialog("파일명");
					file = new File("C:\\Users\\kyle\\workspace\\"+fileName+".txt");
				...
				case "4":
					...
					File updateFile = new File("C:\\Users\\kyle\\workspace\\"+updateFileName+".txt");
				...
				case "5":
					...
					File delFile = new File("C:\\Users\\kyle\\workspace\\"+delFileName+".txt");
					delFile.delete();
					break;
				case "0":
					fw.flush();
